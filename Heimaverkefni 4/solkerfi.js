...
function render()
{
    ...
    rotDay += 3.0;
    rotYear += 0.5;        // not the correct value6, but looks better!
    rotMoon += 6;
    rotLRO += 12
    ...
    mv = mult(mv, rotateX(rotLRO));
    mv = mult(mv, translate(0,1, 1));
    mv = mult( mv, rotateZ( lroTilt ) );
    mv = mult(mv, rotateX( rotDay ));
